...
void stitchedView(int numCams) {
	...
	for (;;)
	{
		...
		case 2: {
			...
			stitcher->stitch(stitchedArray, stitchedFrame1);
			//namedWindow("cam1", WINDOW_AUTOSIZE);
			imshow("Camera Feed", finalFrame);
			break;
		}
		case 3: {
			...
			stitcher->stitch(matArray1, stitchedFrame1);
			stitcher->stitch(stitchedArray, finalFrame);
			//namedWindow("cam1", WINDOW_AUTOSIZE);
			imshow("Camera Feed", finalFrame);
			break;
		}
		case 4: {
			...
			stitcher->stitch(matArray1, stitchedFrame1);
			stitcher->stitch(matArray2, stitchedFrame2);
		...
		case 6: {
			...
			stitcher->stitch(matArray1, stitchedFrame1);
			stitcher->stitch(matArray2, stitchedFrame2);
			stitcher->stitch(matArray3, stitchedFrame3);
